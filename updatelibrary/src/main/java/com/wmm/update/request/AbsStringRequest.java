...
import com.wmm.update.annotation.RequestType;
...
import com.wmm.update.dispatcher.CallbackDispatcher;
import com.wmm.update.exception.CallbackException;
...
public abstract class AbsStringRequest implements IRequest {
